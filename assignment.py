...
import pandas as pd
from data.filters.stopwords import get_stop_words
...
def print_arff(tweets, attributes, attr_count):
    with open("data/system_generated/tweets" + str(attr_count) + ".arff", "w") as file:
        file.write("%\n")
...
if __name__ == '__main__':
    ...
    #all_tweets.to_csv('data/clean_tweets1.csv')